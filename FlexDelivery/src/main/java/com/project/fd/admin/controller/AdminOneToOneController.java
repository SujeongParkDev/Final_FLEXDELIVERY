...
public class AdminOneToOneController {
	...
	private static final Logger logger
		=LoggerFactory.getLogger(AdminOneToOneController.class);
	...
	@RequestMapping(value="/oneToOne/write.do", method=RequestMethod.POST)
	public String write_post(@ModelAttribute AdminAskVO askVo,
			HttpServletRequest request) {
		logger.info("1:1 문의 답변 등록 처리");
		...
		return "redirect:/admin/menu5/oneToOne.do";
	}
	
	@RequestMapping(value="/oneToOne/edit.do", method=RequestMethod.POST)
	...
	public String delete_post(@ModelAttribute AdminAskVO askVo,
		...
		int cnt=askService.deleteAskReply(askVo);
