...
public class OwnerAdvertiseController {
	...
	private static final Logger logger
		=LoggerFactory.getLogger(OwnerAdvertiseController.class);
	...
	@RequestMapping(value = "/advertiseMain.do", method = RequestMethod.POST) 
	public String advertiseMain_get(@RequestParam(defaultValue = "0")int storeNo, Model model) {
		...
		/*
		 * //Q. storeNo을 어떻게 받아와야하지? if(storeNo==0) { model.addAttribute("msg",
		 * "잘못된 url입니다."); model.addAttribute("url", "/index.do");
		 * 
	...
	public String advertiseWrite_post(@ModelAttribute OwnerAdvertiseVO advertiseVo) {
