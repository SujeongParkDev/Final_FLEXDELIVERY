...
<div class="row">
	...
	<div class="col-12 col-md-2"></div>
	<div class="col-12 col-md-8 text-center" >
		<h5>[공지사항] ${ownerBoardVo.boardTitle }</h5>
	...
	<div class="col-12 col-md-8 text-center" >
	    ...
	    <c:set var="bool" value="${bool }"></c:set> 
	   	<c:if test="${bool==true}">
	   	<img src
			="<c:url value='/resources/imgs/ownerMenu_images/${ownerBoardVo.boardThumbnail}'/>" 
	...
	<div class="col-12 col-md-8  text-center" >
		<div>
			<a href="<c:url value='/owner/menu3/notice/notice.do'/>">
