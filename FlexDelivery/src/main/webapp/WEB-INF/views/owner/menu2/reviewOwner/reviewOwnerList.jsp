															...
															<div class="row">
																...
																<div class="text-right" style="margin-bottom: 10px;">
																	<div class="button-group button-group-row align-right ">
																		<br> <br> 
																		<input type="button" class="button small danger inGroup" onclick="btDel(${map['REVIEW_NO']})" style="background-color: #0d6efd; color: white;" value="삭제 ">
																		<input type="button" class="button small secondary inGroup btEdit" onclick="Edit_form(${map['REVIEW_NO']})" style="background-color: r #0d6efd; color: white;" value="수정 ">
																	</div>
																</div>
															</div>
														</div>
