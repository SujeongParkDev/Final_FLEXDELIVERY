...
<head>
	...
	$(document).ready(function(){
		...
		$(function(){
			$('#btMenuWritce').click(function(){
				if($('#mCategoryNo').val()==0){
					alert('죄송합니다 빠른 시일 내로 카테고리를 마련하겠습니다.');
					event.preventDefault();
					self.close();
				}else if($('#menuNo').val()==0){
					alert('메뉴를 먼저 등록 해 주세요');
					window.opener.location.href="${pageContext.request.contextPath}/owner/menu2/foodmenu/menuGroup.do";
					event.preventDefault();
					self.close();
				}else{
