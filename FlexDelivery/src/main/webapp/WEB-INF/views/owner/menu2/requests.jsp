			...
			<div
				...
				<div class="filter-row">
					<select><option value="">전체</option>
						<option value="ShopMenu">가게 메뉴</option>
						<option value="ShopStatus">가게 상태 변경</option>
						<option value="ShopLogo">가게 로고</option>
						<option value="OwnerInfo">사업자 정보 변경</option>
						<option value="OwnerBizLicense">영업신고증 정보 변경</option>
						<option value="OwnerAccount">계좌 정보 수정</option>
						<option value="EtcRequest">배민 사장님 광장 기타 요청</option>
						<option value="ESignContract">업주/광고 계약</option>
						<option value="AdContract">광고 신청</option>
						<option value="SalesAreaAdjustment">배달지역 조정 지원 신청</option>
						<option value="CDD">고객 확인 의무 이행</option></select>
