			...
			<div class="card-content">
				<div class="card-body" id="allreview">
					<p class="card-text text-center"
						style="font-size: 20px; font: bold;">리뷰 관리</p>
										...
										<div class="table-responsive">
											...
											<c:if test="${!empty map['R_COMMENT_CONTENT']}">
												<div class="CEO-comment"
													style="background-color: rgba(208, 201, 208, 0.12); color: #333;">
													<form class="frm2" method="post"
														action="<c:url value='/owner/menu2/reviewOwner/edit.do'/>">
														<input type="hidden" id="reviewNo" name="reviewNo"
															value="${map['REVIEW_NO'] }"> <input
															type="hidden" id="storeNo" name="storeNo" value="1">
															...
															<div class="row">
																...
																<div class="text-right" style="margin-bottom: 10px;">
																	<div class="button-group button-group-row align-right ">
																		...
																		<br>
																		<button type="button"
																			class="button small danger inGroup"
																			onclick="btDel(${map['REVIEW_NO']})"
																			style="background-color: #0d6efd; color: white;">삭제
																		</button>
																		<button type="submit"
																			class="button small danger inGroup"
																			onclick="Edit_form(${map['REVIEW_NO']})"
																			style="background-color: r #0d6efd; color: white;">수정
																		</button>
																	</div>
																</div>
															</div>
												...
												<div class="card-body">
													<form id="frm1" method="post"
														...
														<div style="border: radius 2px solid lightgray;"
															class="text-left">
															<textarea class="form-control form-control-lg comment"
																name="rCommentContent" style="width: 80%;"
																placeholder="사장님 ! 댓글을 등록해주세요."></textarea>
															<input class="button medium" type="submit" onclick=""
																style="background-color: #0d6efd; color: white; padding: 3%;"
																value="댓글작성">
														</div>
													</form>
												</div>
																...
																<div class="text-right" style="margin-bottom: 10px;">
																	<div class="button-group button-group-row align-right ">
																		...
																		<br> <input type="button"
																			...
																			class="button small secondary inGroup btEdit"
																			onclick="Edit_form(${map['REVIEW_NO']})"
																			style="background-color: r #0d6efd; color: white;"
																			value="수정 ">
																	</div>
																</div>
															</div>
													...
													<form id="frm1" method="post"
														...
														<div style="border: radius 2px solid lightgray;"
															...
															<textarea class="form-control form-control-lg comment"
																name="rCommentContent" style="width: 80%;"
																placeholder="사장님 ! 댓글을 등록해주세요."></textarea>
															<input class="button medium write" type="submit"
																onclick=""
																style="background-color: #0d6efd; color: white; padding: 3%;"
																value="댓글작성">
														</div>
