...
<div class="card-body">
	<ul class="nav">
		...
		<li class="nav-item"><a class="nav-link" href="#">운영정보</a></li>
	</ul>
</div>
		...
		<div>
			<div class="Card ">
				...
				<div class="form-group ">
					...
					<div class="inline-values flex-1 mb-1">(47360) 부산광역시 부산진구 범천동
						886-12 1층 피자알파(범천동)</div>
					...
					<div class="form-control-wrap form-control-inline">
						<div class="form-control ">
							<div class="inline-values flex-1 ">
								...
								<br>하나 ☆ 박리다매♡<br>피자는 절대 허접하지 않습니다.<br>드셔보시고 판단
									해주세요.<br>이 불경기에 비싼 피자 부담스럽습니다.<br>어려움을 고객님과 함께 하겠습니다.<br>
								<br>둘 ☆ 재료선정과 맛♡<br>피자알파만의 색깔로 아낌없는 재료와 푸짐한 가성비 그리고
									어디서도 맛볼 수 없는 맛<br>저렴한 가격에도 최상의 맛과 퀄리티로 고객님들에게 만족시켜드릴 수 있도록
									노력하겠습니다.<br>아무리 금액이 저렴해도 맛이 없다면 고객님들의 선택을 받을 수 없습니다.<br>
								<br>셋 ☆ 초심♡<br>처음 가게 오픈해서 처음 주문 받았던 그 감사한 마음을 "절대"잊지
									않고 항상 고객님들의 말씀을 새겨듣는 매장으로 거듭나겠습니다.
								</span>
							</div>
						</div>
					</div>
	...
	<form class="form-card">
		<div>
			<div class="Card ">
				<div class="card-header">
					<h3>
						가게 편의정보 <small class="hint cursor-pointer "><i
				...
				<div class="form-group ">
					<h5 class="form-label">주차</h5>
					<div class="inline-values flex-1 ">
						<span class="text-disabled">설정안함</span>
					</div>
				</div>
				<div class="form-group ">
					<h5 class="form-label">발렛파킹</h5>
					<div class="inline-values flex-1 ">
						<span class="text-disabled">설정안함</span>
					</div>
				</div>
				<div class="form-group ">
					<h5 class="form-label">기타 시설</h5>
					<div class="inline-values flex-1 ">
						<span class="text-disabled">설정안함</span>
					</div>
				</div>
	...
	<form class="form-card">
		<div>
			<div class="Card ">
				...
				<div class="form-group no-divider" style="min-height: auto;">
					<div class="inline-values flex-1 ">
						<span class="text-disabled">주문 고객이 우리 가게를 쉽게 찾을 수 있습니다. 지금
							사용해보세요.</span>
					</div>
				</div>
			</div>
