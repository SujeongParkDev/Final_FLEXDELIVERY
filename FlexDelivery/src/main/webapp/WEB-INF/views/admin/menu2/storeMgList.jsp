    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>가맹점  조회 및 현황</h3>
                <p class="text-subtitle text-muted">전체 가맹점 현황 리스트입니다. </p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class='breadcrumb-header'>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<c:url value='/admin/index.do'/> ">Main</a></li>
                        <li class="breadcrumb-item active" aria-current="page">가맹점 조회/현황</li>
                    </ol>
                </nav>
            </div>
        </div>
          			...
          			<c:if test="${empty list }">
						...
						<c:forEach var="vo" items="${list}">
							<tr>
								...
								<td>
									<p>${vo.storeAddress} ${vo.storeAddressDetail}</p>
								</td>
								<td>
									<p>
								...
								<td><c:if test="${empty vo.storeOutdate}">
									...
									<c:if test="${!empty vo.storeOutdate}">
