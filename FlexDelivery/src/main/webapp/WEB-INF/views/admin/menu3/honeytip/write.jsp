							...
							<div class="col-12">
								<div class="single-blog-area blog-style-2 mb-50">
									<div class="single-blog-content">
										<div class="container">
											<form name="frmHoneytipWrite" id="frmHoneytipWrite" action="<c:url value='/admin/menu3/honeytip/write.do' />" 
												method="post" enctype="multipart/form-data">
										    	<div class="content">
										    		<input type="hidden" name="honeytipNo" value="123">
										        	<div class="row justify-content-md-center">
											            <div class="input-group">
											                <div class="input-group-prepend">
											                    <label class="input-group-text">제목</label>
											                </div>            
											                <input type="text" name="honeytipTitle" id="honeytipTitle" placeholder="제목을 입력하세요" class="form-control">              
										                </div>
									     		 	</div>
									      			<hr>
											 		<div class="row justify-content-md-center">
											          ...
											          <div class="col_c" style="margin-bottom: 30px">
											               <div class="input-group">        
											                 <textarea name="honeytipContent" class="form-control" id="editor4" placeholder="내용을 입력하세요"></textarea>   
